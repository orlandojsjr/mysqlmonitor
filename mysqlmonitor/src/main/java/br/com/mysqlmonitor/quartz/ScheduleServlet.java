...
public class ScheduleServlet extends HttpServlet {
    ...
    /*
     * Metodo carregado quando o tomcat inicia.
     * Agendamento executado de 30 em 30 minutos de segunda a sexta.
     */
    @Override
    public void init() {
        try {
    ...
    /*
     * Metodo executado quando o tomcat para.
     */
    @Override
    public void destroy() {
        try {
            sched.shutdown();
            System.out.println("Schedule shutdown !"); 
        } catch (SchedulerException e) {
            System.out.println("Erro ao parar Schedule.");
        }
    }
